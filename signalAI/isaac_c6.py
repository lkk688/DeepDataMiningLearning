...
def eval_radar_on_val_set_dual(
    ...
    for thr in dl_thr_sweep:
        ...
        for f in val_files:
            ...
            dets = _dl_detect(rd_f_db, ra_f, va_f, net_fmcw, thr=thr, max_peaks=64, adapt=False, domain="fmcw")
            gtinfo = _gt_rv_az(gts, sp)
            pairs  = _match_dets_to_gts(dets, gtinfo, w_r=1.0, w_v=0.5)
            ...
            dets = _dl_detect(rd_o_db, ra_o, va_o, net_otfs, thr=thr, max_peaks=64, adapt=True, domain="otfs")
            gtinfo = _gt_rv_az(gts, sp)
            pairs  = _match_dets_to_gts(dets, gtinfo, w_r=1.0, w_v=0.5)
    ...
    for f in val_files:
        ...
        # FMCW DL
        dets = _dl_detect(rd_f_db, ra_f, va_f, net_fmcw, thr=fixed_thr, domain="fmcw")
        pairs = _match_dets_to_gts(dets, gtinfo, w_r=1.0, w_v=0.5)
        ...
        dets = _dl_detect(rd_o_db, ra_o, va_o, net_otfs, thr=fixed_thr, domain="otfs")
        pairs = _match_dets_to_gts(dets, gtinfo, w_r=1.0, w_v=0.5)
        a,b = _tp_errs(pairs, gtinfo); 
