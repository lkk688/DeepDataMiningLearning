...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--resume", default="/data/cmpe249-fa23/trainoutput/kitti/model_36.pth", type=str, help="path of checkpoint") #/data/cmpe249-fa23/trainoutput/kitti/model_4.pth
