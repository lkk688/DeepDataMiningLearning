#ref: https://github.com/pytorch/examples/blob/main/siamese_network/main.py
...
class SiameseNetwork(nn.Module):
    ...
    def init_weights(self, m):
        if isinstance(m, nn.Linear):
            torch.nn.init.xavier_uniform_(m.weight) #https://pytorch.org/docs/stable/nn.init.html
...
class APP_MATCHER(Dataset):
    def __init__(self, root, train, download=False):
        ...
        self.data = self.dataset.data.unsqueeze(1).clone() #[60000, 1, 28, 28]
    ...
    def group_examples(self):
        ...
        np_arr = np.array(self.dataset.targets.clone()) #[60000]
