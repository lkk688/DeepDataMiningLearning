...
def main():
    ...
    ap.add_argument("--ckpt", default="/data/rnd-liu/MyRepo/mmdetection3d/work_dirs/mybevfusion7_crossattnaux_painting/epoch_1.pth", type=str, help="Path to checkpoint (e.g., epoch_1.pth)")
