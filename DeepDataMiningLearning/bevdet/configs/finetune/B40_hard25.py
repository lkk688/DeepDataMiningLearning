# Hard-mining efficiency test: pseudo-ONLY finetune on a hard25 subset of the
# Waymo pseudo pool (no GT mix), from the B14 pretrained init. Eval on Waymo GT.
_base_ = ['./B18_pseudo_label_v14.py']
SUB = '/fs/atipa/data/rnd-liu/MyRepo/DeepDataMiningLearning/data/waymo_finetune/waymo_v1_infos_train_pseudo_qmix_v0b_hard25.pkl'
...
work_dir = '/fs/atipa/data/rnd-liu/MyRepo/mmdetection3d/work_dirs/B40_hard25'
