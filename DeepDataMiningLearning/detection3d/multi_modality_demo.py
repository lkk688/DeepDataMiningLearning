...
basedfolder = r'D:\Developer'
def parse_args():
    parser = ArgumentParser()
    parser.add_argument('pcd', default='demo/data/kitti/000008.bin', help='Point cloud file')
    parser.add_argument('img', default='demo/data/kitti/000008.png', help='Image file')
    parser.add_argument('infos', default='demo/data/kitti/000008.pkl', help='Infos file with annotations')
    parser.add_argument('model', default='configs/pointpillars/pointpillars_hv_secfpn_8xb6-160e_kitti-3d-3class.py', help='Config file')
    parser.add_argument('weights', default='modelzoo_mmdetection3d/hv_pointpillars_secfpn_6x8_160e_kitti-3d-3class_20220301_150306-37dc2420.pth', help='Checkpoint file')
    parser.add_argument(
