...
load_from = '/data/rnd-liu/MyRepo/mmdetection3d/modelzoo_mmdetection3d/hv_pointpillars_secfpn_6x8_160e_kitti-3d-3class_20220301_150306-37dc2420.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/data/rnd-liu/MyRepo/mmdetection3d/data/kitti/kitti_infos_val.pkl',
        backend_args=None,
        box_type_3d='LiDAR',
        data_prefix=dict(pts='training/velodyne_reduced'),
        data_root='/data/rnd-liu/MyRepo/mmdetection3d/data/kitti',
        metainfo=dict(classes=[
            'Pedestrian',
            'Cyclist',
            'Car',
